...
import baguetteImage from "../../assets/resultJpg/baguette.png";
...
function ResultBaguette() {
  ...
  return (
    <div className="flex flex-col items-center justify-start p-4 ">
      <img src={baguetteImage} alt="Baguette" className="object-contain md:w-96 w-80 mt-20" />
      <br />
      <div onClick={handleRestart} className="mt-[-1rem]">
        <Start>再測一次</Start>
      </div>
      <div className="absolute bottom-32 left-12 z-20">
        <ResultSticker color={color} content={baguettecolor}/>
      </div>
